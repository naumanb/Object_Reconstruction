...
def main():
    ...
    parser.add_argument('--model', default='./saves/XMem-s012.pth')
    # For generic (G) evaluation, point to a folder that contains "JPEGImages" and "Annotations"
    parser.add_argument('--generic_path',default='../input')

    parser.add_argument('--dataset', help='D16/D17/Y18/Y19/LV1/LV3/G', default='G')
    parser.add_argument('--split', help='val/test', default='val')
    parser.add_argument('--output', default='../input/')
    parser.add_argument('--save_all', action='store_true', help='Save all frames. Useful only in YouTubeVOS/long-time video', )
